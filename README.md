...
This plugin shows the Readme content of a repository.

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-readme-plugin/docs).
